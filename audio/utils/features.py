...
def pack_audio_files_to_hdf5_ramas(args):
    ...
    if mini_data:
        ...
        packed_hdf5_path = os.path.join(workspace, 'features_ramas', 'waveform_meta_test.h5')
    ...
    meta_df = pd.read_csv('/home/den/DATASETS/AUDIO/preprocessed/ramas/meta_test.csv', sep=',')
    ...
    meta_dict = {
        ...
        'fold': np.array([1 for audio_name in audio_names])}
